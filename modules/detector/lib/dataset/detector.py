...
class DetectionDataset(JointsDataset):
    def __init__(self, cfg, root, image_set, unittest, is_train, transform=None):
        super().__init__(cfg, root, image_set, unittest, is_train, transform)
    ...
    def _get_db(self):
        ...
        for a in anno:
            ...
            if self.image_set != "test":
                ...
                assert len(joints) == self.num_joints, "joint num diff: {} vs {}".format(
                    len(joints), self.num_joints
                )
